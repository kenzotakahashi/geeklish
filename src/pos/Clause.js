...
const Clause = function(c) {
  ...
  this.getVerbForQuestion = function(v) {
  ...
  this.punctuation = () => this.c_type === 'question' ? '?' : '.';
  this.sentence = (c) => this.capitalize(c + this.punctuation());
