import { Verb, VerbLink, VerbDetail,
				 Be, BeLink, BeDetail,
...
import { Noun, NounLink, NounDetail,
				 NounContainer, NounContainerLink, NounContainerDetail,
				 NounClause } from './Noun.jsx'
import { Determiner, DeterminerLink, DeterminerDetail,
...
import { Conjunction, ConjunctionLink, ConjunctionDetail } from './Conjunction.jsx'
